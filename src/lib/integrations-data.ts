...
export const INTEGRATIONS: IntegrationDef[] = [
  ...
  { id: 'sicoob', name: 'Sicoob', domain: 'sicoob.com.br', color: '#007A3D', description: 'Integre sua conta cooperativa Sicoob ao FinDash Pro.', imports: ['Extrato', 'Poupança'], status: 'available', category: 'bancos', method: 'ofx_import' },
