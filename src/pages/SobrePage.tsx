  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-bg-base)' }}>
      ...
      <div className="max-w-[760px] mx-auto px-6 pt-[60px] pb-[80px]">
        ...
        <h1 className="font-black tracking-[-0.8px] mb-4" style={{ fontSize: 'clamp(28px, 4vw, 40px)', color: 'var(--color-text-strong)' }}>Sobre o KoraFinance</h1>

        <p className="text-[15px] mb-6" style={{ color: 'var(--color-text-muted)', lineHeight: 1.8 }}>
          O KoraFinance nasceu da necessidade de um painel financeiro completo, bonito e intuitivo para brasileiros que levam dinheiro a sério. Acreditamos que o controle financeiro deve ser acessível, poderoso e — por que não — prazeroso.
        </p>
        ...
        <div className="p-6 rounded-xl" style={{ background: 'var(--color-bg-sunken)' }}>
          ...
          <p className="text-[14px]" style={{ color: 'var(--color-text-muted)' }}>E-mail: <a href="mailto:contato@korafinance.com.br" className="underline" style={{ color: 'var(--color-green-600)' }}>contato@korafinance.com.br</a></p>
          <p className="text-[13px] mt-2" style={{ color: 'var(--color-text-subtle)' }}>© 2026 KoraFinance. Todos os direitos reservados. Made with 💚 no Brasil</p>
        </div>
      </div>
      <Footer />
    </div>
