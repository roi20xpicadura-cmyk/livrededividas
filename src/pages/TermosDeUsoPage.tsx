  ...
  return (
    <LegalPageLayout label="LEGAL" title="Termos de Uso" updatedAt="14 de abril de 2026" version="1.0" sections={sections}>
      <section id="aceitacao" className="mb-10">
        ...
        <p className="legal-p">Ao criar uma conta no FinDash Pro, você concorda com estes Termos de Uso. Se não concordar, não utilize o serviço. Estes termos se aplicam a todos os usuários da plataforma.</p>
      </section>
      <section id="descricao" className="mb-10">
        <h2 className="legal-h2">2. Descrição do Serviço</h2>
        <p className="legal-p">O FinDash Pro é uma plataforma de gestão financeira pessoal e empresarial que permite ao usuário registrar receitas, despesas, metas financeiras, dívidas, cartões de crédito e investimentos. O serviço é oferecido via web e aplicativo móvel (PWA).</p>
      </section>
      <section id="cadastro" className="mb-10">
        <h2 className="legal-h2">3. Cadastro e Conta</h2>
        <ul className="legal-ul">
          <li>3.1 Para usar o FinDash Pro, você deve criar uma conta com e-mail válido e senha segura (mínimo 8 caracteres).</li>
      ...
      <section id="planos" className="mb-10">
        ...
        <ul className="legal-ul">
          <li>4.1 O FinDash Pro oferece planos gratuito (Free), Pro e Business.</li>
      ...
      <section id="uso" className="mb-10">
        ...
        <p className="legal-p">É proibido usar o FinDash Pro para:</p>
        <ul className="legal-ul">
      ...
      <section id="dados" className="mb-10">
        ...
        <ul className="legal-ul">
          ...
          <li>6.2 O FinDash Pro não verifica a veracidade dos dados inseridos.</li>
        ...
        <div className="legal-highlight">⚠️ As análises e projeções do FinDash Pro são meramente informativas e não substituem consultoria financeira profissional.</div>
      </section>
      <section id="propriedade" className="mb-10">
        <h2 className="legal-h2">7. Propriedade Intelectual</h2>
        <ul className="legal-ul">
          <li>7.1 O FinDash Pro e todo seu conteúdo (software, design, textos, logotipos) são protegidos por direitos autorais.</li>
      ...
      <section id="limitacao" className="mb-10">
        ...
        <ul className="legal-ul">
          <li>8.1 O FinDash Pro é fornecido "como está", sem garantias de disponibilidade ininterrupta.</li>
      ...
      <section id="contato" className="mb-10">
        ...
        <p className="legal-p">Para dúvidas: <a href="mailto:juridico@findashpro.com.br" className="underline" style={{ color: 'var(--color-green-600)' }}>juridico@findashpro.com.br</a></p>
      </section>
    </LegalPageLayout>
  );
}
