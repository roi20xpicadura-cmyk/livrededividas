  ...
  return (
    <section className="relative py-20 md:py-32 px-4 bg-[#0f172a] overflow-hidden">
      <div className="absolute inset-0 -z-0">
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 60% 80% at 50% 50%, rgba(124, 58, 237,0.20) 0%, transparent 70%)' }} />
        <div className="absolute left-1/4 top-1/4 w-[300px] md:w-[400px] h-[300px] md:h-[400px] rounded-full bg-[rgba(124, 58, 237,0.12)] blur-[80px] md:blur-[100px]" />
      ...
      <div className="relative z-10 max-w-[700px] mx-auto text-center">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="flex items-center justify-center gap-3 mb-6 md:mb-8">
          <div className="flex -space-x-2">
            {['bg-[#7C3AED]', 'bg-[#2563eb]', 'bg-[#7c3aed]'].map((c, i) => (
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
          <Link to="/register" className="h-[52px] md:h-[60px] px-8 md:px-10 rounded-2xl bg-[#7C3AED] text-white text-[16px] md:text-[18px] font-[800] hover:bg-[#22c55e] transition-all duration-200 inline-flex items-center gap-2"
            style={{ boxShadow: '0 8px 40px rgba(124, 58, 237,0.4)' }}>
