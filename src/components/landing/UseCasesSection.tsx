      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1, duration: 0.5, ease }}
            className="bg-[#0f172a] rounded-[20px] md:rounded-[24px] p-6 md:p-10">
            ...
            <span className="text-[10px] md:text-[11px] font-[700] text-[#0f172a] bg-white px-3 py-1 rounded-full">Meu Negócio</span>
