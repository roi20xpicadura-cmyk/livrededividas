...
const faqs = [
  ...
  { q: 'O app funciona no celular?', a: 'Sim. O KoraFinance é um PWA — funciona no iPhone e Android igual a um app nativo, sem precisar instalar pela App Store. Basta acessar no navegador e adicionar à tela inicial.' },
